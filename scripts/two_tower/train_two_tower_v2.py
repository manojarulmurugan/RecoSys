...
def _ensure_gcp_credentials() -> None:
    ...
    print(
        ...
        "to the full path of recosys-service-account.json before running, or place "
        f"the file at one of: {_REPO_ROOT / 'secrets' / 'recosys-service-account.json'}, "
        f"{_REPO_ROOT / 'recosys-service-account.json'}, /content/recosys-service-account.json"
    )
